...
export function getValue(ownerRates, oneHomeCollection) {
    ...
    for (let i = 0; i < 2; i++) {
        const intermediateProposedValues = findProposedValues(ownerRates, proposedValues.current, oneHomeCollection)
...
const findProposedValues = (rates, currProposedValues, oneHomeCollection, skip, skip2) => {
...
export const getValueOfPokemon = (category, pValues) => {
