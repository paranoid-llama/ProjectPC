...
export default function BallProgress({ball, position, className, size, lgScreen, circleOrientation, selected, handleBallChange, circleCenterBall, addLabel, smallerSizeLabel, progress}) {
