...
export default function ComparisonSelection({dataState, changeCollection, changeOption, tradeableCollections, collectionOwnerUsername, collectionGen, userCollectionGen, changeScreen, isPending, optionType, changeOptionType}) {
    ...
    return (
        <>
        <Box sx={{...modalStyles.onhand.modalElementBg, height: '8%', width: '95%'}}>
        ...
        <Box sx={{...modalStyles.onhand.modalElementBg, height: '42%', width: '95%', mt: 1, ...theme.components.box.fullCenterCol}}>
            <Typography sx={{fontWeight: 700, fontSize: '14px', mb: 1}}>Select which of your collections you want to compare with:</Typography>
        ...
        <Box sx={{...modalStyles.onhand.modalElementBg, height: '40%', width: '95%', mt: 1, ...theme.components.box.fullCenterCol, position: 'relative'}}>
            ...
            <Box sx={{...theme.components.box.fullCenterCol, justifyContent: 'start', width: '80%', height: '75%', gap: 0.5}}>
            ...
            {optionType === 'advanced' &&
                <Box sx={{...theme.components.box.fullCenterCol, justifyContent: 'start', width: '70%', height: '75%', gap: 0.5}}>
                    <Box sx={{...theme.components.box.fullCenterRow, height: '100%', width: '90%', gap: 0.5}}>
                        <Box sx={{...theme.components.box.fullCenterCol, justifyContent: 'start', width: '100%', height: '100%', gap: 0.5}}>
                            <Box sx={{...theme.components.box.fullCenterRow, justifyContent: 'start', height: '20%', width: '100%'}}>
                                <Box sx={{position: 'relative'}}>
                                    <Typography>Equalize baby/adult pokemon:</Typography>
                            ...
                            <Box sx={{...theme.components.box.fullCenterRow, justifyContent: 'start', height: '20%', width: '100%'}}><Typography>Include Legendary Pokemon:</Typography></Box>
                            <Box sx={{...theme.components.box.fullCenterRow, justifyContent: 'start', height: '20%', width: '100%'}}><Typography>Include Non-Breedable Pokemon:</Typography></Box>
                            <Box sx={{...theme.components.box.fullCenterRow, justifyContent: 'start', height: '20%', width: '100%'}}><Typography>Include Evolved Regional Pokemon:</Typography></Box>
                        </Box>
                        <Box sx={{...theme.components.box.fullCenterCol, justifyContent: 'start', width: '30%', height: '100%'}}>
                            <Checkbox checked={dataState.advancedOptions.equalizeBabyAdults} onChange={() => changeOption('adv', 'equalizeBabyAdults')} sx={{color: 'white', ml: 2}}/>
                            <Checkbox checked={dataState.advancedOptions.legendary} onChange={() => changeOption('adv', 'legendary')} sx={{color: 'white', ml: 2}}/>
                            <Checkbox checked={dataState.advancedOptions.nonBreedable} onChange={() => changeOption('adv', 'nonBreedable')} sx={{color: 'white', ml: 2}}/>
                            <Checkbox checked={dataState.advancedOptions.evolvedRegional} onChange={() => changeOption('adv', 'evolvedRegional')} sx={{color: 'white', ml: 2}}/>
                        </Box>
                    </Box>
                </Box>
            }
            <Button onClick={changeOptionType} sx={{position: 'absolute', top: '2px', right: '2px', fontSize: '12px'}} size='small'>{optionType === 'basic' ? 'Advanced' : 'Basic'} Options</Button>
        </Box>
        <Box sx={{...modalStyles.onhand.modalElementBg, height: '6%', width: '95%', mt: 1, ...theme.components.box.fullCenterCol}}>
