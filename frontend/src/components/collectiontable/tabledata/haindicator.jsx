...
export default function HAIndicator({sx, textOnly, topPosition=false, isEditMode, isHAActive, handleChange}) {
    const mediaQuery = topPosition ? haTopMediaQuery : haBottomMediaQuery
